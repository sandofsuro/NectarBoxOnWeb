...
import {
 ...
 import UIExplorerApp from './UIExplorer/UIExplorerApp.web';
import Components from './views/components.web';
 ...
 componentWillMount() {
  ...
  _renderView(name){
   ...
   var view;
    switch (name){
      case 'UIExplorer':
        view = <UIExplorerApp></UIExplorerApp>
        break;
      default :
...
AppRegistry.runApplication('MDP', {
  rootTag: app
})
